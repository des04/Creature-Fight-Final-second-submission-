    ...
    public void attack(int idx)
    {
        ...
        else
        {
            ...
            if ( enemyType.equalsIgnoreCase("Grass"))
            {
                 ...
                 */
                getWorld().showText( "The attack was super effective", getWorld().getWidth()/2, getWorld().getHeight()+26 );
            ...
            else if ( enemyType.equalsIgnoreCase("Rock"))
            {
                 ...
                 *          and a y location of half the height of the world plus 26 pixels
                 */
                getWorld().showText( "The attack wasn't very effective", getWorld().getWidth()/2, getWorld().getHeight()+26 );
